...
# Usa la variable de entorno si está disponible, si no usa basededatos (nombre del servicio en Docker)
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://postgres:best4ever@basededatos:5432/rackiq_db")
